...
public struct CellKey: Codable, Sendable, Hashable, Comparable {
  ...
  public init(record: ConformanceRecord) {
    self.init(
      model: record.model, quant: record.quant, backend: record.backend, renderer: record.renderer)
  }
...
public struct BaselineEntry: Codable, Sendable, Equatable {
  ...
  public init(
    score: Double, bytesHash: String, divergenceClass: String?, timestamp: Date, coreCommit: String
  ) {
    self.score = score
...
public struct BaselineStore: Codable, Sendable, Equatable {
  ...
  public func updated(with observations: [CellKey: CellObservation], timestamp: Date)
    -> BaselineStore
  {
