...
public enum BenchResultValidationError: Error, CustomStringConvertible, Equatable {
  ...
  public var description: String {
    switch self {
    case .sampleCountMismatch(let field, let expected, let actual):
...
public struct BenchResult: Codable, Sendable, Equatable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    loadDurationMsPerRun =
      try container.decodeIfPresent([Double?].self, forKey: .loadDurationMsPerRun) ?? []
    prefillTpsPerRun =
      try container.decodeIfPresent([Double?].self, forKey: .prefillTpsPerRun) ?? []
    generateTpsPerRun =
      try container.decodeIfPresent([Double?].self, forKey: .generateTpsPerRun) ?? []
    medianTtftMs =
      try container.decodeIfPresent(Double.self, forKey: .medianTtftMs)
      ?? Self.median(ttftMsPerRun)
    medianTps =
      try container.decodeIfPresent(Double.self, forKey: .medianTps)
      ?? Self.median(tpsPerRun)
    minTtftMs =
      try container.decodeIfPresent(Double.self, forKey: .minTtftMs)
      ?? (ttftMsPerRun.min() ?? 0)
    maxTtftMs =
      try container.decodeIfPresent(Double.self, forKey: .maxTtftMs)
      ?? (ttftMsPerRun.max() ?? 0)
    minTps =
      try container.decodeIfPresent(Double.self, forKey: .minTps)
      ?? (tpsPerRun.min() ?? 0)
    maxTps =
      try container.decodeIfPresent(Double.self, forKey: .maxTps)
      ?? (tpsPerRun.max() ?? 0)
    medianLoadDurationMs =
      try container.decodeIfPresent(Double.self, forKey: .medianLoadDurationMs)
      ?? Self.medianOfPresent(loadDurationMsPerRun)
    medianPrefillTps =
      try container.decodeIfPresent(Double.self, forKey: .medianPrefillTps)
      ?? Self.medianOfPresent(prefillTpsPerRun)
    medianGenerateTps =
      try container.decodeIfPresent(Double.self, forKey: .medianGenerateTps)
      ?? Self.medianOfPresent(generateTpsPerRun)
    p90TtftMs =
      try container.decodeIfPresent(Double.self, forKey: .p90TtftMs)
      ?? Self.percentile(ttftMsPerRun, 0.90)
    p99TtftMs =
      try container.decodeIfPresent(Double.self, forKey: .p99TtftMs)
      ?? Self.percentile(ttftMsPerRun, 0.99)
    p90Tps =
      try container.decodeIfPresent(Double.self, forKey: .p90Tps)
      ?? Self.percentile(tpsPerRun, 0.90)
    p99Tps =
      try container.decodeIfPresent(Double.self, forKey: .p99Tps)
      ?? Self.percentile(tpsPerRun, 0.99)
    p90Rank =
      try container.decodeIfPresent(Int.self, forKey: .p90Rank)
      ?? Self.rank(for: 0.90, count: ttftMsPerRun.count)
    p99Rank =
      try container.decodeIfPresent(Int.self, forKey: .p99Rank)
